    ...
    <>
      ...
      <nav
        ...
        style={{
          ...
          bottom: 0,
          left: "50%",
          width: "min(var(--tg-shell-width, 420px), calc(100dvw - var(--tg-safe-left, 0px) - var(--tg-safe-right, 0px)))",
          maxWidth: "min(var(--tg-shell-width, 420px), calc(100dvw - var(--tg-safe-left, 0px) - var(--tg-safe-right, 0px)))",
