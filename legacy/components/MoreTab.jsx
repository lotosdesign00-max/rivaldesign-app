...
function MoreTab({ th, t, lang, showToast, streak, onUnlockAchieve, addXPfn }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      {/* в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ ABOUT в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ */}
      {section === "about" && (
      ...
      {/* в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ REVIEWS в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ */}
      {section === "reviews" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 10, animation: "moreIn .35s ease both" }}>
          ...
          <div style={{ display: "flex", gap: 6, overflowX: "auto", scrollbarWidth: "none" }}>
            {[0, 5, 4, 3].map((rating) => (
              ...
              >
                {rating === 0 ? (t.allRatings || "Все") : <span style={{ display: "inline-flex", gap: 2 }}>{Array.from({ length: rating }).map((_, idx) => <SystemIcon key={idx} name="star" size={11} color="#fbbf24" animated />)}</span>}
              </button>
            ))}
          </div>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
                      ...
                      {review.verified && (
                        ...
                        }}><SystemIcon name="check" size={11} color="#34d399" animated style={{ marginRight: 4 }} /> verified</span>
                      )}
                    </div>
      ...
      {/* в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ FAQ в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ */}
      {section === "faq" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 12, animation: "moreIn .35s ease both" }}>
