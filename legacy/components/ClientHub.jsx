                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "flex-start" }}>
                      <div style={{ minWidth: 0, flex: 1 }}>
                        ...
                        <div style={{ fontSize: 12, color: th.sub, lineHeight: 1.6, marginTop: 8 }}>
                          {paymentMethodLabel(payment.method, lang)} · {fmtDate(payment.createdAt, lang)}
                          {payment.orderNo ? ` · ${lang === "en" ? "Order" : "Заказ"} #${payment.orderNo}` : ""}
                        </div>
                      </div>
                      <span
                        style={{
                      ...
                      >
                        <span style={{ width: 7, height: 7, borderRadius: "50%", background: meta.color, boxShadow: `0 0 10px ${meta.color}55` }} />
