...
function FreePackTab({ th, t, lang }) {
  ...
  const catDefs = {
    ru: [
      ...
      { id: "fonts",     name: "Шрифты",    icon: "Aa" },
      { id: "textures",  name: "Текстуры",  icon: "▩" },
      { id: "brushes",   name: "Кисти",     icon: "✏" },
      { id: "templates", name: "Шаблоны",   icon: "▣" },
      { id: "mockups",   name: "Мокапы",    icon: "◫" },
      { id: "graphics",  name: "Графика",   icon: "✦" },
    ],
    en: [
      { id: "all",       name: "All",       icon: "◈" },
      { id: "fonts",     name: "Fonts",     icon: "Aa" },
      { id: "textures",  name: "Textures",  icon: "▩" },
      { id: "brushes",   name: "Brushes",   icon: "✏" },
  ...
  if (!isSubscribed) {
    const previewItems = [
      { icon: "Aa", title: lang === "ru" ? "Шрифты"   : "Fonts",     count: "25+", color: "#f59e0b", desc: lang === "ru" ? "Premium типографика" : "Premium typefaces" },
      { icon: "▩",  title: lang === "ru" ? "Текстуры" : "Textures",  count: "40+", color: "#10b981", desc: lang === "ru" ? "Фоны и нойзы" : "Backgrounds & noise" },
      { icon: "✏",  title: lang === "ru" ? "Кисти"    : "Brushes",   count: "30+", color: "#3b82f6", desc: lang === "ru" ? "Для Photoshop/Procreate" : "For PS/Procreate" },
      { icon: "▣",  title: lang === "ru" ? "Шаблоны"  : "Templates", count: "15+", color: "#8b5cf6", desc: lang === "ru" ? "Готовые макеты" : "Ready-made layouts" },
    ];
              ...
              <div style={{
                ...
                {!file.preview && (
                  <div style={{
                    ...
                    {cats.find(c => c.id === file.category)?.icon || "◈"}
                  </div>
                )}
              </div>
