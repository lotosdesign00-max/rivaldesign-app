  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        ><SystemIcon name="close" size={16} color="rgba(200,210,255,.8)" animated /></button>
        ...
        <div style={{ position: "relative", display: "inline-flex", alignItems: "center", justifyContent: "center", marginBottom: 26, marginTop: 8 }}>
          ...
          <div style={{
            ...
            <SystemIcon name={achievement.icon || "trophy"} size={48} color="#fff" animated />
          </div>
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 8, marginBottom: 14, animation: "achieveFadeUp .4s ease .3s both" }}>
          ...
          }}><SystemIcon name="visual" size={10} color="#818cf8" animated /> Achievement</div>
          {achievement.secret && (
            <div style={{
            ...
            }}><SystemIcon name="lock" size={10} color="#f59e0b" animated /> Secret</div>
          )}
        </div>
          ...
          <div style={{
            ...
            position: "relative", overflow: "hidden"
             ...
             <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
               <SystemIcon name="xp" size={24} color="#e0e7ff" animated />
