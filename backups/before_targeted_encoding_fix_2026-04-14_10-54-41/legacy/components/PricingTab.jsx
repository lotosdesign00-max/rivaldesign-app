    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <button onClick={onSub} disabled={qty === 0} style={{ width: 34, height: 34, borderRadius: 10, border: qty === 0 ? `1px solid ${ui.accent}18` : `1px solid ${ui.accent}55`, background: qty === 0 ? `${ui.accent}0f` : `${ui.accent}18`, color: qty === 0 ? ui.sub : ui.text, fontSize: 18, fontWeight: 900, cursor: qty === 0 ? "not-allowed" : "pointer" }}>в€’</button>
