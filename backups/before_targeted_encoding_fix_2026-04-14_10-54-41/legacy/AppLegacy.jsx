...
const QUIZ_QUESTIONS_POOL = [
  ...
  { q: "Золотое сечение ≈", opts: ["1.414", "1.618", "1.732", "2.000"], correct: 1, exp: "П† = 1.618... — основа гармоничных пропорций в дизайне" },
...
const ACHIEVEMENTS = [
  ...
  { id: "mega_fan", icon: "в­ђ", title: "Мега-фан", desc: "10+ визитов", xp: 100, secret: false },
...
export default function App() {
  ...
  }, [addOrderMessage, lang, orders, pushTimelineEntry, showToast]);
