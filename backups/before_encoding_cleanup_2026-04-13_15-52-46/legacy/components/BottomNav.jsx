...
const NAV_ITEMS = [
  ...
  { id: "orders",  icon: "orders-mark",  label: "navOrders" },
...
function OrdersMark({ active, th }) {
  return (
    <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true" style={{ display: "block" }}>
      <defs>
        <linearGradient id="nav-orders-g" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor={active ? th.hi : "rgba(148,163,184,.5)"} />
          <stop offset="100%" stopColor={active ? th.accentB : "rgba(100,116,139,.4)"} />
        </linearGradient>
      </defs>
      ...
      <path
        ...
        fill={active ? th.tag : "rgba(255,255,255,.02)"}
        stroke="url(#nav-orders-g)" strokeWidth="1.6" strokeLinejoin="round"
      />
      <path d="M10 3v2c0 .6.4 1 1 1h2c.6 0 1-.4 1-1V3" fill="none" stroke="url(#nav-orders-g)" strokeWidth="1.4" strokeLinecap="round" />
      <path d="M9 10h6M9 14h6M9 18h3" fill="none" stroke="url(#nav-orders-g)" strokeWidth="1.3" strokeLinecap="round" opacity="0.8" />
    </svg>
  );
}
...
function BottomNav({ active, onChange, th, t, cartCount, ordersCount = 0, sfx }) {
            ...
            >
              ...
              <span style={{
                ...
                {n.id === "gallery" ? <PaletteMark active={isActive} th={th} /> :
                 ...
                 n.id === "orders"  ? <OrdersMark active={isActive} th={th} /> :
