    ...
    >
      ...
      <button
        ...
        style={{
          ...
          boxShadow: "0 12px 30px rgba(0,0,0,.18), inset 0 1px 0 rgba(255,255,255,.04)",
          padding: "18px 18px",
          display: "flex",
          alignItems: "center",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, minWidth: 0 }}>
          <div
            style={{
              ...
              height: 48,
              borderRadius: 16,
              background: `linear-gradient(135deg, ${th.accent}22, ${th.accentB}18)`,
              border: `1px solid ${th.border}`,
              display: "flex",
              alignItems: "center",
          ...
          <div style={{ minWidth: 0 }}>
            <div style={{ fontSize: 15, fontWeight: 900, color: th.text }}>
              {lang === "en" ? "Open order desk" : "Открыть кабинет заказов"}
            </div>
            <div style={{ fontSize: 11.5, color: th.sub, lineHeight: 1.55, marginTop: 4 }}>
              {lang === "en"
                ? "Payments, queue, statuses and messages in one place."
                : "Платежи, очередь, статусы и сообщения в одном месте."}
            </div>
          </div>
        </div>
        <div
