        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 14, position: "relative", zIndex: 1 }}>
          ...
          <div style={{
            ...
            <svg viewBox="0 0 24 24" width="26" height="26" fill="none">
              <rect x="3" y="5" width="18" height="14" rx="3" stroke={th.id === "graphite" ? "rgba(255,255,255,.7)" : th.accent} strokeWidth="1.6" fill="none" />
              <path d="M3 10h18" stroke={th.id === "graphite" ? "rgba(255,255,255,.4)" : th.accent + "66"} strokeWidth="1.2" />
              <circle cx="17" cy="14" r="1.5" fill={th.id === "graphite" ? "rgba(255,255,255,.7)" : th.accent} />
            </svg>
          </div>
        </div>
      </div>
