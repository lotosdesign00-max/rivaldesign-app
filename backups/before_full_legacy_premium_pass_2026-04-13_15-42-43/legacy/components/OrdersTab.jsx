/**
 * ORDERS TAB — Баланс, заказы, пополнение через CryptoBot
 * Вынесено из ProfileTab в отдельную вкладку
 */
    ...
    >
      ...
      >
        ...
        <div className="type-display" style={{ fontSize: 24, color: th.text, marginTop: 8 }}>
          {lang === "en" ? "Balance & Orders" : "Баланс и заказы"}
        </div>
        ...
        <>
          ...
          >
            ...
            <div style={{ fontSize: 12.5, color: th.sub, lineHeight: 1.6, marginTop: 10 }}>
              {lang === "en"
                ? "Use the balance for instant payment inside the app or keep CryptoBot drafts for separate checkouts."
                : "Используй баланс для мгновенной оплаты внутри приложения или храни черновики оплат через CryptoBot."}
            </div>
              ...
              <div style={{ display: "flex", gap: 10 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 900,
                    cursor: "pointer",
                    boxShadow: "0 6px 22px rgba(99,102,241,0.40), inset 0 1px 0 rgba(255,255,255,0.15)",
                    transition: "all 0.2s ease",
                  }}
                  onMouseEnter={(e) => {
