...
function MoreTab({ th, t, lang, showToast, streak, onUnlockAchieve, addXPfn }) {
  ...
  const sections = [
    { id: "about",   label: lang === "en" ? "About"   : "О нас",   icon: "◎" },
    { id: "reviews", label: lang === "en" ? "Reviews" : "Отзывы",  icon: "✦" },
  ...
  const directions = [
    { icon: "◈", title: lang === "en" ? "Avatars"       : "Аватарки",       sub: lang === "en" ? "Profile identity, signature mood."  : "Визуальный образ и настроение." },
    { icon: "▣", title: lang === "en" ? "Previews"      : "Превью",          sub: lang === "en" ? "YouTube & Twitch visuals."          : "YouTube и Twitch-визуал." },
    { icon: "▤", title: lang === "en" ? "Banners"       : "Баннеры",         sub: lang === "en" ? "Channel headers & promos."          : "Шапки канала и промо." },
    { icon: "✦", title: lang === "en" ? "Visual Systems": "Визуал-системы",  sub: lang === "en" ? "Consistent content set."            : "Системный набор визуала." },
    { icon: "◉", title: lang === "en" ? "Promo"         : "Промо",           sub: lang === "en" ? "Launch & campaign graphics."        : "Анонсы и запуск." },
    { icon: "◐", title: lang === "en" ? "Custom"        : "Нестандарт",      sub: lang === "en" ? "Tailored to your niche."            : "Под твою нишу." },
  ];
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, animation: "moreIn .35s ease both" }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              ✦ {lang === "en" ? "Graphic Designer" : "Графический дизайнер"}
            </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span>⚙</span> {lang === "en" ? "Tools" : "Инструменты"}
            </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span>◈</span> {lang === "en" ? "Main directions" : "Направления"}
            </div>
      ...
      {section === "reviews" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 10, animation: "moreIn .35s ease both" }}>
          ...
          <div style={{ position: "relative" }}>
            <span style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", fontSize: 14, color: "rgba(99,102,241,.5)", pointerEvents: "none" }}>⌕</span>
            <input
              value={reviewSearch}
            ...
            return (
              <div key={review.id} className="more-review-card"
                ...
                <div style={{ display: "flex", gap: 7 }}>
                  ...
                  >{liked ? "♥" : "♡"} {likeCount > 0 ? likeCount : ""}</button>
                </div>
              </div>
            );
          })}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, animation: "moreIn .35s ease both" }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span>◈</span> {lang === "en" ? "Answer" : "Ответ"}
            </div>
