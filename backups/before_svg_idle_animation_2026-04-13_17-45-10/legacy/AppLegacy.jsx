            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 84, justifyContent: "flex-end", position: "relative", zIndex: 1 }}>
              ...
              >
                <svg viewBox="0 0 24 24" width="16" height="16" fill="none" style={{ flexShrink: 0 }}>
                  <rect x="3" y="5" width="18" height="14" rx="3" stroke={th.id === "graphite" ? "rgba(255,255,255,.6)" : th.accent} strokeWidth="1.6" fill="none" />
                  <circle cx="17" cy="14" r="1.3" fill={th.id === "graphite" ? "rgba(255,255,255,.6)" : th.accent} />
                </svg>
