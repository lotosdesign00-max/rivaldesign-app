...
function homeCopy(lang) {
  return lang === "en"
    ...
    : {
        ...
        heroBody:
          "Премиальные визуальные системы для креаторов, стримеров и брендов. Четкое направление, чистая иерархия и результат, который ощущается дорогим с первого экрана.",
