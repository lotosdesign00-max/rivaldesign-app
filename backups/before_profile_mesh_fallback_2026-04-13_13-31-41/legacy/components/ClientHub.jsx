...
export default function ClientHub({
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ position: "absolute", top: -60, right: -40, width: 180, height: 180, borderRadius: "50%", background: `radial-gradient(circle, ${th.glow} 0%, transparent 72%)`, filter: "blur(16px)", opacity: 0.48, pointerEvents: "none", transform: "translateZ(0)" }} />
        <div className="type-micro" style={{ color: th.sub, fontSize: 10 }}>
