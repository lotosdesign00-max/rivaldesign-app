...
function FreePackTab({ th, t, lang }) {
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 16, animation: animate ? "packFadeIn .5s ease both" : "none" }}>
        ...
        <div style={{
          ...
          >
            {subscribing ? (
              <>вЏі {lang === "ru" ? "Открываем..." : "Unlocking..."}</>
            ) : (
              <>в†— {lang === "ru" ? "Подписаться на канал" : "Subscribe to Channel"}</>
            )}
          </button>
  ...
  /* в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ UNLOCKED VIEW в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ */
  return (
            ...
            >
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {isDown ? (
                    <span style={{ animation: "dlSpin .6s linear infinite", display: "inline-block" }}>в†»</span>
                  ) : "в†“"}
                </div>
