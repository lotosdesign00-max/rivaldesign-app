      ...
      >
        ...
        <div style={{ position: "relative", margin: "4px 14px 0" }}>
          ...
          {item.popular && (
            <div style={{
              ...
              <SystemIcon name="top" size={11} color="#fff" animated style={{ marginRight: 4 }} />
              TOP
            </div>
          )}
          ...
          <div style={{
            ...
            <SystemIcon name="eye" size={12} color="rgba(200,210,255,.72)" /> {fmtViews(item.views)}
          </div>
        ...
        <div style={{ padding: "16px 18px 28px" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12, marginBottom: 10 }}>
            ...
            ><SystemIcon name={wl ? "heart-filled" : "heart"} size={16} color={wl ? "#c7d2fe" : "rgba(100,116,139,.7)"} animated={wlAnimating || wl} /></button>
          </div>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            >
              <SystemIcon name="telegram" size={14} color="#fff" animated />
              {t.orderBtn || "Заказать"}
            </button>
