    ...
    <>
      ...
      >
        ...
        {popular && (
          ...
          >
            <SystemIcon name="top" size={12} color="#fff" animated style={{ marginRight: 6 }} />
            POPULAR
          </div>
        )}
        ...
        >
          <SystemIcon name={liked ? "heart-filled" : "heart"} size={16} color={liked ? "#fff" : "rgba(148,163,184,0.7)"} animated={liked} />
        </button>
        ...
        <div style={{ padding: 12 }}>
          ...
          {views && (
            ...
            >
              <SystemIcon name="eye" size={12} color="rgba(100,116,139,0.72)" />
