...
const COUNTRIES = [
  { id: "ru", flag: "RU", name: "Россия", nameEn: "Russia", details: "Карта / банк / e-wallet / перевод" },
  { id: "ua", flag: "UA", name: "Украина", nameEn: "Ukraine", details: "Monobank / PrivatBank / IBAN" },
  { id: "kz", flag: "KZ", name: "Казахстан", nameEn: "Kazakhstan", details: "Kaspi / Halyk / перевод" },
  { id: "by", flag: "BY", name: "Беларусь", nameEn: "Belarus", details: "Карта / банк" },
  { id: "eu", flag: "EU", name: "Европа", nameEn: "Europe", details: "SEPA / Revolut" },
  { id: "other", flag: "OT", name: "Другой регион", nameEn: "Other region", details: "Подберем удобный способ оплаты" },
];
  ...
  const copy = useMemo(
    () =>
      isEn
        ...
        : {
            title: "Альтернативные реквизиты",
            body: "Выбери свой регион, и я открою прямой запрос на самый удобный способ оплаты.",
            method: "Предпочтительный способ",
            cancel: "Отмена",
            send: "Отправить запрос",
            successTitle: "Запрос отправлен",
            successBody: "Дизайнер пришлет реквизиты в Telegram.",
          },
    [isEn]
  );
      ...
      >
        ...
        {sent ? (
          <div style={{ position: "relative", zIndex: 1, textAlign: "center", padding: "28px 8px 20px" }}>
            <div style={{ width: 68, height: 68, borderRadius: 22, margin: "0 auto 16px", background: "linear-gradient(135deg, #10b981, #059669)", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 10px 28px rgba(16,185,129,.38)" }}><SystemIcon name="check" size={30} color="#fff" animated /></div>
