  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <SystemIcon name={achievement.icon || "trophy"} size={24} color="#fff" animated />
      </div>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{
          ...
          <SystemIcon name="visual" size={10} color="#818cf8" animated /> Achievement Unlocked
        </div>
        <div style={{
        ...
        <div style={{
          ...
          <SystemIcon name="star" size={11} color="#e0e7ff" animated /> +{achievement.xp} XP
        </div>
      </div>
