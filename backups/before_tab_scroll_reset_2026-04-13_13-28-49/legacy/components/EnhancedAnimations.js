/**
 * EnhancedAnimations — библиотека премиум анимаций
 * Готовые CSS анимации для использования в компонентах
 */

export const EnhancedAnimations = `
/* ═══════════════════════════════════════════════════════════════
   ВХОДНЫЕ АНИМАЦИИ (Entry Animations)
   ═══════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════
   ВЫХОДНЫЕ АНИМАЦИИ (Exit Animations)
   ═══════════════════════════════════════════════════════════════ */
...
.animate-smooth { animation-timing-function: cubic-bezier(0.4, 0, 0.2, 1); }
