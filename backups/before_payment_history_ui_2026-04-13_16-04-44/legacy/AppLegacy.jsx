...
const T = {
  ru: {
    ...
    navHome: "Главная", navGallery: "Галерея", navAI: "AI", navOrders: "Заказы", navPricing: "Прайс", navFreePack: "Пак", navMore: "Ещё", navProfile: "Профиль",
  ...
  en: {
    ...
    navHome: "Home", navGallery: "Gallery", navAI: "AI", navOrders: "Orders", navPricing: "Pricing", navFreePack: "Pack", navMore: "More", navProfile: "Profile",
      ...
      <div style={{ width: "100%", maxWidth: 480, display: "flex", flexDirection: "column", height: "100dvh", position: "relative", zIndex: 1 }}>
        ...
        <main ref={mainRef} style={{ flex: 1, padding: "14px 16px 100px", overflowY: "auto", WebkitOverflowScrolling: "touch", overscrollBehavior: "contain" }}>
          ...
          >
            ...
            {tab === "orders" && <OrdersTab th={th} lang={lang} walletBalance={walletBalance} paymentHistory={paymentHistory} orders={orders} onRequestTopUp={requestTopUp} onMarkPaymentSubmitted={markPaymentSubmitted} onRefreshInvoiceStatus={refreshInvoiceStatus} onAddOrderMessage={addOrderMessage} onOpenCryptoBot={openCryptoBot} onOpenTelegram={openOrderTelegram} onRequestPaymentDetails={requestPaymentDetails} />}
            {tab === "more" && <MoreTab th={th} t={t} lang={lang} showToast={showToast} streak={streak} onUnlockAchieve={unlockAchievement} addXPfn={addXPfn} />}
            {tab === "profile" && <ProfileTab th={th} t={t} lang={lang} streak={streak} achievements={achievements} showToast={showToast} setTab={setTab} setSelectedAchievement={setSelectedAchievement} />}
          </div>
        </main>

        <BottomNav active={tab} onChange={setTab} th={th} t={t} cartCount={cartCount} ordersCount={activeOrdersCount} sfx={SFX} />
      </div>
