...
const GALLERY_TRANSLATIONS = {
  ...
  en: [ 
    ...
    { id: "25", category: "Previews", title: "Fresh Selection of Works", image: "/images/мокап для превьюшек.jpg", description: "Bring your idea to life in design with us" },
  ...
  ua: [
    ...
    { id: "25", category: "Прев'ю", title: "Свіжа підбірка робіт", image: "/images/мокап для превьюшек.jpg", description: "Втіли свою ідею в дизайн разом з нами" },
  ...
  kz: [
    ...
    { id: "25", category: "Превью", title: "Жаңа таңдау шолуы", image: "/images/мокап для превьюшек.jpg", description: "Бізбен бірге идеяңызды дизайн арқылы өмірге әкеліңіз" },
  ...
  by: [
    ...
    { id: "25", category: "Прэв'ю", title: "Свежы падбор твораў", image: "/images/мокап для превьюшек.jpg", description: "Ажыццявіце сваю ідэю ў дызайне з намі" },
